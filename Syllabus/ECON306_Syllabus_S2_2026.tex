...
% Week 1
W1 D1 & Wed 15 Jul & Course welcome; what is health economics; six special characteristics; case for govt involvement & Alchian \& Allen pp.~75--6; Santerre \& Neun pp.~18--21 \\
...
% Week 3
W3 D1 & Wed 29 Jul & Invisible hand baseline; normative vs.\ positive theories of intervention & Donaldson \& Gerard Ch.~3; Feldstein pp.~437--42; Rice \& Unruh pp.~161--9 \\
...
% Week 4
W4 D1 & Wed 5 Aug & Demographic transition; NZ's ageing population; why ageing matters economically & WHO \textit{World Report on Ageing}; \textit{The Economist}: ``The silver tsunami'' \\
...
% Week 5
W5 D1 & Wed 12 Aug & Why insurance exists; risk aversion \& expected utility; actuarially fair premiums \& pooling & Feldstein Ch.~6 \\
...
% Week 6
W6 D1 & Wed 19 Aug & Hospitals as economic institutions; Jacobs taxonomy; Newhouse non-profit model & Santerre \& Neun pp.~406--12; McPake \& Normand Ch.~21; Ashton et al.\ (2005); Kerr (1975); Logan (1986) \\
...
% Week 7
W7 D1 & Wed 26 Aug & The NZ health system in depth: history of reforms (1938 Social Security Act to Te Whatu Ora) and the reasoning behind its structural choices & Readings to be announced on Brightspace \\
...
% Week 8
W8 D1 & Wed 9 Sep & Allocating the health budget; the four types of economic evaluation (CMA/CBA/CEA/CUA); PHARMAC and the NZ framework & Devlin \& Hansen (2000) NZ Treasury WP; Kernick (1998) \textit{BMJ} 316 \\
W8 D2 & Thu 10 Sep & Valuing human life: human capital, implied valuation, WTP/VSL & \textit{The Economist}: ``The price of a life'' (1993); Kobelt pp.~75--99; Drummond et al.\ Ch.~2 \\
W8 D3 & Fri 11 Sep & Discounting \& time value; decision-making under risk vs.\ uncertainty & Salvatore Ch.~14; \textit{The Economist}: ``Apocalypse maybe'' (1996) \\
...
% Week 9
W9 D1 & Wed 16 Sep & QALYs and the EQ-5D-5L; eliciting utility weights (VAS/TTO/SG); applying CUA: ICERs, cost-per-QALY, the PHARMAC threshold & Kobelt: ``Cost-utility analysis'' pp.~75--89; Fairfax NZ News (2013) \\
W9 D2 & Thu 17 Sep & Equity: fair innings, distributional value judgements, social preferences; league tables; dementia \& end-of-life & (see Wed) \\
W9 D3 & Fri 18 Sep & Is QALY-max enough? MCDA concepts \& methods (PAPRIKA, 1000minds); discrete choice experiments; ISPOR good practice & Buchanan \& O'Connell (2006) \textit{HBR}; Hansen \& Devlin (2019); Golan \& Hansen (2012) \\
\end{longtable}
...
% Week 10
W10 D1 & Wed 23 Sep & Education as an economic good; similarities/differences vs.\ health; market failures in education & Hansen: ``Borrowing to learn, or learning to borrow?''; Ehrenberg \& Smith Ch.~9 \\
W10 D2 & Thu 24 Sep & NZ education system; student loan scheme economics (income-contingent, interest-free) & (see Wed) \\
W10 D3 & Fri 25 Sep & Human capital: NPV \& IRR; NZ age-earnings profiles; MOOCs \& lifelong learning & \textit{The Economist}: ``Creative destruction'' (2014); ``The digital degree'' (2014); ``Established providers'' (2017) \\
...
% Week 11
W11 D1 & Wed 30 Sep & Signalling theory (Spence 1973); separating equilibria & \textit{The Economist}: ``Secrets and agents'' (Jul 2016) \\
W11 D2 & Thu 1 Oct & Human capital vs.\ signalling: evidence; sheepskin effects & (see Wed) \\
W11 D3 & Fri 2 Oct & Private vs.\ social returns (NZ); user-pays vs.\ public funding & (see Wed) \\
\end{longtable}
...
\begin{itemize}
  \item Readings on the history and structure of the NZ health system — to be announced on Brightspace.
\end{itemize}

\subsection{Week 8 — Economic Evaluation, Valuing Life, and Discounting}
\begin{itemize}
  \item Devlin, N.\ \& Hansen, P.\ (2000), NZ Treasury Working Paper 00/4.
  \item Kernick, D.\ (1998), \textit{BMJ}, 316, 1663--1665.
  \item \textit{The Economist}, ``The price of a life'' (December 1993).
  \item Kobelt, G., pp.~75--99.
  \item Drummond, M.\ et al., Ch.~2.
  \item Salvatore, D., Ch.~14 excerpts (discounting).
  \item \textit{The Economist}, ``Apocalypse maybe'' (March 1996).
\end{itemize}

\subsection{Week 9 — QALYs, Equity, and Multi-Criteria Decision Analysis}
\begin{itemize}
  \item Kobelt, G., ``Cost-utility analysis'', pp.~75--89.
  \item Fairfax NZ News, ``Outgoing drug boss says it's not easy to play God'' (September 2013).
  \item Buchanan, L.\ \& O'Connell, A.\ (2006), \textit{Harvard Business Review}, 84, 32--41.
  \item Hansen, P.\ \& Devlin, N.\ (2019), \textit{Oxford Research Encyclopedia of Economics and Finance}.
...
\begin{itemize}
  ...
  \item \textit{The Economist}, ``Creative destruction'' (June 2014).
  \item \textit{The Economist}, ``The digital degree'' (June 2014).
  \item \textit{The Economist}, ``Established providers v new contenders'' (January 2017).
  \item Ehrenberg, R.\ \& Smith, R., Ch.~9.
\end{itemize}

\subsection{Week 11 — Signalling Theory and Returns to Education}
\begin{itemize}
  \item \textit{The Economist}, ``Secrets and agents'' (July 2016).
\end{itemize}
