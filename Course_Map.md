...
**Readings marked `[PENDING Phase 4 refresh]` use current syllabus readings; they will be updated in Phase 4.**
**Last updated:** 2026-06-12 (Phase 2 complete; dates and calendar flags signed off by Austin)
...
| **Required readings** | Alchian & Allen, "Need versus demand" and "Alleged exceptions to the law of demand," pp. 75–6 in *Exchange and Production*, Wadsworth, 1964. Santerre & Neun, "The theories X and Y of health economics," pp. 18–21 in *Health Economics*, Dryden Press, 2000. [PENDING Phase 4 refresh] | (See W01D1 readings; no separate required reading) [PENDING Phase 4 refresh] | (No separate required reading listed in current syllabus) [PENDING Phase 4 refresh] |
...
| **Required readings** | Wagstaff (1986), *Journal of Epidemiology and Community Health*, 40, 1–11. [PENDING Phase 4 refresh] | (see W02D1) [PENDING Phase 4 refresh] | (see W02D1) [PENDING Phase 4 refresh] |
...
| **Required readings** | Donaldson & Gerard: Ch. 3. Feldstein: pp. 437–42. Rice & Unruh: pp. 161–9. [PENDING Phase 4 refresh] | (see W03D1) [PENDING Phase 4 refresh] | (see W03D1) [PENDING Phase 4 refresh] |
...
| **Required readings** | WHO: *World Report on Ageing and Health* (selected chapters). *The Economist*: "The silver tsunami." [PENDING Phase 4 refresh] | (see W04D1) [PENDING Phase 4 refresh] | (see W04D1) [PENDING Phase 4 refresh] |
...
| **Required readings** | Feldstein: Ch. 6 (demand for health insurance). [PENDING Phase 4 refresh — note: placeholder "something about how public systems are basically insurance?" in current syllabus to be resolved in Phase 4] | (see W05D1) [PENDING Phase 4 refresh] | (see W05D1) [PENDING Phase 4 refresh] |
| **Evaluation touchpoints** | Reading quiz due | — | — |
...
| **Required readings** | Santerre & Neun: pp. 406–12. McPake & Normand: Ch. 21. Ashton, Mays & Devlin (2005). Kerr S. "On the folly of rewarding A, while hoping for B," *Academy of Management Journal*, 1975, 18(4): 769–83. Logan (1986): "Bob's Party" [tutorial reading]. [PENDING Phase 4 refresh] | (see W06D1) [PENDING Phase 4 refresh] | (see W06D1) [PENDING Phase 4 refresh] |
...
| **Required readings** | Readings on NZ health system history — to be selected in Phase 4 (Austin priority: history and reasoning behind NZ health/education system structures) | Review all Part I readings | — (no new reading) |
...
| **Required readings** | Devlin & Hansen (2000), *NZ Treasury Working Paper 00/4*. Kernick (1998), *BMJ* 316, 1663–5. [PENDING Phase 4 refresh] | *The Economist*: "The price of a life" (Dec 1993). Kobelt: pp. 75–99. Drummond et al.: Ch. 2. [PENDING Phase 4 refresh] | Salvatore: Ch. 14 excerpts (discounting). "Apocalypse maybe," *The Economist* (Mar 1996). [PENDING Phase 4 refresh] |
...
| **Required readings** | Kobelt: "Cost-utility analysis," pp. 75–89. Fairfax NZ News: "Outgoing drug boss says it's not easy to play God" (Sep 2013). [PENDING Phase 4 refresh] | (see W09D1) [PENDING Phase 4 refresh] | Buchanan & O'Connell (2006), *Harvard Business Review*, 84, 32–41. Hansen & Devlin (2019), *Oxford Research Encyclopedia*. Golan & Hansen (2012), *Israel Journal of Health Policy Research*, 1, 44. [PENDING Phase 4 refresh] |
| **Evaluation touchpoints** | Reading quiz due | — | — |
...
| **Required readings** | Hansen: "Borrowing to learn, or learning to borrow?" Ehrenberg & Smith: Ch. 9. [PENDING Phase 4 refresh] | (see W10D1) [PENDING Phase 4 refresh] | *The Economist*: "Creative destruction" (Jun 2014). *The Economist*: "The digital degree" (Jun 2014). *The Economist*: "Established providers v new contenders" (Jan 2017). [PENDING Phase 4 refresh] |
...
| **Required readings** | *The Economist*: "Secrets and agents" (Jul 2016). [PENDING Phase 4 refresh] | (see W11D1) [PENDING Phase 4 refresh] | (see W11D1) [PENDING Phase 4 refresh] |
| **Evaluation touchpoints** | Reading quiz due | — | — |
...
| **Required readings** | Review all required readings from Weeks 1–11. [PENDING Phase 4 refresh] | — | — |
