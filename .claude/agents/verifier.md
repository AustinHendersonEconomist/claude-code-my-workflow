---
name: verifier
description: End-to-end verification agent. Checks that slides compile and produce correct PDF output. Use proactively before committing or creating PRs.
...
- Use `TEXINPUTS=../Preambles:$TEXINPUTS` for LaTeX so the shared preamble resolves
